...
@IBDesignable class HBSegmentedControl: UIControl {
    ...
    @IBInspectable var font : UIFont = UIFont.LensFont.regular.fontWithSize(size: 18.0) {
        didSet {
            setFont()
        }
    }
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            label.font = UIFont.LensFont.regular.fontWithSize(size: 17.0)
...
//        UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.1, animations: {
//
//            self.thumbView.frame = label.frame
//
//            }, completion: nil)
